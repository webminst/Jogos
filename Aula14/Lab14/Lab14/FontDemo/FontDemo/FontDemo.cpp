...
void FontDemo::Draw()
{
    ...
    consolas->Draw(60, 135, "abcdefghijklmnopqrstuvwxyz!@#$%&*(+^~çáêôüã", red);
    ...
    verdana->Draw(60, 375, "Esta é a fonte Verdana 12 pontos", black, Layer::FRONT, 0.75, -30);
    verdana->Draw(60, 405, "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", black, Layer::FRONT, 1.5, 45);
    verdana->Draw(60, 435, "abcdefghijklmnopqrstuvwxyz!@#$%&*(+^~çáêôüã", black, Layer::FRONT, 1.75, -60);
